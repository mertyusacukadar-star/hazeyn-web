...
const PAGE_CSS = `<style>
  ...
  .seo-hotel-card{padding:0;overflow:hidden}.seo-hotel-card>div{padding:26px}.seo-hotel-card b{display:block;color:var(--gold);margin-top:12px}.seo-hotel-media{position:relative;margin:0;height:280px;overflow:hidden;background:#eee}.seo-hotel-media img{width:100%;height:100%;object-fit:cover;transition:transform .4s ease}.seo-hotel-card:hover .seo-hotel-media img{transform:scale(1.035)}.seo-hotel-media span{position:absolute;right:16px;bottom:14px;padding:7px 11px;border-radius:999px;background:rgba(12,12,14,.72);color:#fff;font-size:12px;font-weight:800;backdrop-filter:blur(8px)}.seo-price-card{display:flex;flex-direction:column;gap:12px;min-height:190px}.seo-price-card strong{font-size:26px;margin-top:auto}.seo-price-card.featured{border-color:rgba(196,145,47,.55);background:linear-gradient(145deg,#fff,#fff8e7)}.seo-check-list{list-style:none;padding:0;margin:0;display:grid;gap:10px}.seo-check-list li{position:relative;padding-left:25px}.seo-check-list li:before{content:"✓";position:absolute;left:0;color:var(--gold);font-weight:900}.seo-check-list.excluded li:before{content:"–"}.seo-prose{font-size:17px;color:#38332d}.seo-prose p{margin:0 0 18px}.seo-detail-toggle{padding:0;overflow:hidden}.seo-detail-toggle summary{list-style:none;cursor:pointer;padding:26px;display:flex;align-items:center;justify-content:space-between;gap:20px}.seo-detail-toggle summary::-webkit-details-marker{display:none}.seo-detail-toggle summary h2{margin:0}.seo-detail-toggle summary:after{content:"+";display:grid;place-items:center;width:38px;height:38px;flex:0 0 38px;border-radius:50%;background:#f6eddd;color:var(--gold);font-size:25px;font-weight:700;transition:transform .25s ease,background .25s ease}.seo-detail-toggle[open] summary:after{transform:rotate(45deg);background:var(--gold);color:#fff}.seo-detail-content{padding:0 26px 26px;border-top:1px solid var(--line)}.seo-detail-content p:first-child{margin-top:22px}.seo-gallery{display:grid;grid-template-columns:repeat(3,1fr);gap:16px}.seo-gallery figure{margin:0;border-radius:20px;overflow:hidden;background:#111;min-height:240px}.seo-gallery img{width:100%;height:100%;min-height:240px;object-fit:cover}.seo-expired{display:flex;align-items:center;justify-content:space-between;gap:20px;background:#241d15;color:#fff;border-radius:22px;padding:24px 28px;margin:24px 0}.seo-expired strong{font-size:22px}.seo-expired p{margin:4px 0 0;color:rgba(255,255,255,.72)}
...
<html lang="tr"><head>
  ...
  <link rel="icon" type="image/png" sizes="32x32" href="/assets/icon.png"><link rel="apple-touch-icon" href="/assets/icon.png"><link rel="stylesheet" href="/style.css?v=20260813-program2">${jsonLd}
...
function renderProgramPage(state, tourInput, origin) {
  ...
  const hotelImage = (images, alt) => images && images.length ? `<figure class="seo-hotel-media"><img src="${escapeHtml(images[0])}" alt="${escapeHtml(alt)}" loading="lazy" decoding="async">${images.length > 1 ? `<span>${images.length} görsel</span>` : ''}</figure>` : '';
  ...
  const content = `<section class="seo-hero"><img class="seo-hero-media pos-${escapeHtml(tour.detailBannerPosition)}" src="${escapeHtml(tour.detailBannerImage)}" alt="${escapeHtml(`${tour.detailBannerTitle} program banner görseli`)}" fetchpriority="high"><div class="container seo-hero-copy">
    ...
    ${expiredPanel}
    <section class="seo-section"><div class="seo-section-head"><span class="section-kicker">Konaklama ve ulaşım</span><h2>Mekke ve Medine otelleri</h2></div><div class="seo-grid-2"><article class="seo-card seo-hotel-card">${hotelImage(tour.hotelImages.mekke, `${tour.mekkeHotelName} Mekke oteli`)}<div><span class="section-kicker">Mekke</span><h3>${escapeHtml(tour.mekkeHotelName)}</h3><b>Harem’e mesafe / servis</b><p>${escapeHtml(tour.mekkeDistanceService)}</p></div></article><article class="seo-card seo-hotel-card">${hotelImage(tour.hotelImages.medine, `${tour.medineHotelName} Medine oteli`)}<div><span class="section-kicker">Medine</span><h3>${escapeHtml(tour.medineHotelName)}</h3><b>Mescid-i Nebevî’ye mesafe / servis</b><p>${escapeHtml(tour.medineDistanceService)}</p></div></article></div><article class="seo-card" style="margin-top:20px"><span class="section-kicker">Uçuş</span><h3>Havayolu ve uçuş bilgileri</h3><p>${escapeHtml(tour.flightDetails)}</p></article></section>
    ...
    <section class="seo-section"><div class="seo-grid-2"><details class="seo-card seo-prose seo-detail-toggle"><summary><span><span class="section-kicker">Ziyaretler</span><h2>Ziyaret programı</h2></span></summary><div class="seo-detail-content">${paragraphs(tour.visitProgram || 'Mekke ve Medine ziyaretleri kafile rehberi eşliğinde programlanır.')}</div></details><details class="seo-card seo-prose seo-detail-toggle"><summary><span><span class="section-kicker">Gün gün akış</span><h2>Program ayrıntıları</h2></span></summary><div class="seo-detail-content">${paragraphs(tour.program)}</div></details></div></section>
